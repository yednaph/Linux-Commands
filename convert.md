...
To convert an N page pdf to N images (will autonumber): `convert -density 150 fileoriginal.pdf -quality 80 'outputfile.jpg'

To convert an N page pdf to N images with explicit filename formatting: `convert -density 150 fileoriginal.pdf -quality 80 'outputfile-%d.jpg'`
